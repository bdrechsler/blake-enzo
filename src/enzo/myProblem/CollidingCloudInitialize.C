                             ...
                             TopGridData &MetaData, int SetBaryonFields)
{
  ...
  const char *SIH4_DUSTIName = "SIH4_DUSTI_Density";
  const char *H2SIO_DUSTIName = "H2SIO_DUSTI_Density";
  const char *SIC_DUSTIName = "SIC_DUSTI_Density";
  const char *SIC2_DUSTIName = "SIC2_DUSTI_Density";
  const char *SIC3_DUSTIName = "SIC3_DUSTI_Density";
  ...
  const char *SIO_DUSTIName = "SIO_DUSTI_Density";
  ...
  while (CurrentGrid != NULL)
  {
    if (CurrentGrid->GridData->CollidingCloudInitializeGrid(
            ...
            ImpactParameter) == FAIL)
    { // 123456 New Parameters!!
  ...
  */
      ...
      for (level = 0; level < MaximumRefinementLevel; level++)
      {
        ...
        while (Temp != NULL)
        {
          if (Temp->GridData->CollidingCloudInitializeGrid(
                  ...
                  RelativeVelocity, Btheta, ImpactParameter) == FAIL)
          { // 123456 New Parameters !!
            fprintf(stderr, "Error in CollidingCloudInitializeGrid.\n");
            return FAIL;
          }
    ...
    if (MultiSpecies)
    {
      ...
      if (MultiSpecies == KROMESPECIES)
      {
        ...
        DataLabel[count++] = (char *)SIH4_DUSTIName;
        DataLabel[count++] = (char *)H2SIO_DUSTIName;
        DataLabel[count++] = (char *)SIC_DUSTIName;
        DataLabel[count++] = (char *)SIC2_DUSTIName;
        DataLabel[count++] = (char *)SIC3_DUSTIName;
        ...
        DataLabel[count++] = (char *)SIO_DUSTIName;
