                                       ...
                                       int SetBaryonFields, float RelativeVelocity, float Btheta, float ImpactParameter) // GMC collision parameters
{
  ...
  float specMass[NKROMESPECIES] = {
      ...
      1.700e+01, 3.000e+01, 2.800e+01, 5.200e+01, 6.400e+01,
      4.000e+01, 3.000e+01, 3.100e+01, 2.600e+01, 2.800e+01,
      2.800e+01, 1.600e+01, 1.500e+01, 1.600e+01, 1.400e+01,
      1.500e+01, 3.200e+01, 2.900e+01, 4.400e+01, 4.000e+00,
      3.100e+01, 3.200e+01, 4.400e+01, 2.800e+01, 4.600e+01,
      4.300e+01, 4.600e+01, 3.300e+01, 4.200e+01, 3.200e+01,
      4.300e+01, 3.000e+01, 3.200e+01, 4.600e+01, 4.000e+01,
      5.200e+01, 6.400e+01, 1.600e+01, 2.800e+01, 1.800e+01,
      3.000e+01, 4.400e+01, 2.800e+01, 2.700e+01, 1.700e+01,
      3.200e+01, 4.600e+01, 3.100e+01, 3.300e+01, 2.800e+01,
      2.400e+01, 2.700e+01, 0.000e+00, 4.400e+01, 2.900e+01,
      1.000e+00, 2.900e+01, 1.200e+01, 1.400e+01, 1.300e+01,
      3.000e+01, 2.400e+01, 1.700e+01, 3.000e+01, 2.800e+01,
      5.200e+01, 6.400e+01, 4.000e+01, 3.000e+01, 3.100e+01,
      2.600e+01, 2.800e+01, 2.800e+01, 3.200e+01, 1.800e+01,
      1.600e+01, 1.600e+01, 1.700e+01, 1.500e+01, 1.600e+01,
      1.400e+01, 2.700e+01, 1.500e+01, 3.200e+01, 2.900e+01,
      4.400e+01, 2.000e+00, 4.000e+00, 3.100e+01, 3.200e+01,
      3.000e+00, 3.100e+01, 1.900e+01, 2.800e+01, 4.500e+01,
      5.000e+00, 2.900e+01, 3.300e+01, 3.300e+01, 4.500e+01};
#endif
  ...
  if (MultiSpecies)
  {
    ...
    if (MultiSpecies == KROMESPECIES)
    {
      ...
      FieldType[SIH4_DUSTINum = NumberOfBaryonFields++] = SIH4_DUSTIDensity;
      FieldType[H2SIO_DUSTINum = NumberOfBaryonFields++] = H2SIO_DUSTIDensity;
      FieldType[SIC_DUSTINum = NumberOfBaryonFields++] = SIC_DUSTIDensity;
      FieldType[SIC2_DUSTINum = NumberOfBaryonFields++] = SIC2_DUSTIDensity;
      FieldType[SIC3_DUSTINum = NumberOfBaryonFields++] = SIC3_DUSTIDensity;
      ...
      FieldType[SIO_DUSTINum = NumberOfBaryonFields++] = SIO_DUSTIDensity;
      ...
      speciesMap[17] = SIINum;
      speciesMap[18] = SIC2INum;
      speciesMap[19] = SIC3INum;
      speciesMap[20] = SICINum;
      speciesMap[21] = SIH2INum;
      speciesMap[22] = SIH3INum;
      speciesMap[23] = CNINum;
      speciesMap[24] = COINum;
      speciesMap[25] = N2INum;
      speciesMap[26] = NH2INum;
      speciesMap[27] = CH3INum;
      speciesMap[28] = CH4INum;
      speciesMap[29] = NINum;
      speciesMap[30] = NHINum;
      speciesMap[31] = SIH4INum;
      speciesMap[32] = SIHINum;
      speciesMap[33] = SIOINum;
      speciesMap[34] = HeINum;
      speciesMap[35] = HNOINum;
      speciesMap[36] = CH3OHINum;
      speciesMap[37] = CO2INum;
      speciesMap[38] = H2CNINum;
      speciesMap[39] = H2SIOINum;
      speciesMap[40] = HNCOINum;
      speciesMap[41] = NO2INum;
      speciesMap[42] = O2HINum;
      speciesMap[43] = OCNINum;
      speciesMap[44] = CH3OH_DUSTINum;
      speciesMap[45] = HNCO_DUSTINum;
      speciesMap[46] = H2CO_DUSTINum;
      speciesMap[47] = SIH4_DUSTINum;
      speciesMap[48] = H2SIO_DUSTINum;
      speciesMap[49] = SIC_DUSTINum;
      speciesMap[50] = SIC2_DUSTINum;
      speciesMap[51] = SIC3_DUSTINum;
      speciesMap[52] = CH4_DUSTINum;
      speciesMap[53] = CO_DUSTINum;
      speciesMap[54] = H2O_DUSTINum;
      speciesMap[55] = NO_DUSTINum;
      speciesMap[56] = CO2_DUSTINum;
      speciesMap[57] = N2_DUSTINum;
      speciesMap[58] = HCN_DUSTINum;
      speciesMap[59] = NH3_DUSTINum;
      speciesMap[60] = O2_DUSTINum;
      speciesMap[61] = NO2_DUSTINum;
      speciesMap[62] = HNO_DUSTINum;
      speciesMap[63] = O2H_DUSTINum;
      speciesMap[64] = H2CN_DUSTINum;
      speciesMap[65] = MG_DUSTINum;
      speciesMap[66] = HNC_DUSTINum;
      speciesMap[67] = E_DUSTINum;
      speciesMap[68] = SIO_DUSTINum;
      speciesMap[69] = HCOIINum;
      speciesMap[70] = HIINum;
      speciesMap[71] = HOCIINum;
      speciesMap[72] = CIINum;
      speciesMap[73] = CH2IINum;
      speciesMap[74] = CHIINum;
      speciesMap[75] = H2COIINum;
      speciesMap[76] = MGIINum;
      speciesMap[77] = NH3IINum;
      speciesMap[78] = NOIINum;
      speciesMap[79] = SIIINum;
      speciesMap[80] = SIC2IINum;
      speciesMap[81] = SIC3IINum;
      speciesMap[82] = SICIINum;
      speciesMap[83] = SIH2IINum;
      speciesMap[84] = SIH3IINum;
      speciesMap[85] = CNIINum;
      speciesMap[86] = COIINum;
      speciesMap[87] = N2IINum;
      speciesMap[88] = O2IINum;
      speciesMap[89] = H2OIINum;
      speciesMap[90] = NH2IINum;
      speciesMap[91] = OIINum;
      speciesMap[92] = OHIINum;
      speciesMap[93] = CH3IINum;
      speciesMap[94] = CH4IINum;
      speciesMap[95] = NIINum;
      speciesMap[96] = HCNIINum;
      speciesMap[97] = NHIINum;
      speciesMap[98] = SIH4IINum;
      speciesMap[99] = SIHIINum;
      speciesMap[100] = SIOIINum;
      speciesMap[101] = H2IINum;
      speciesMap[102] = HeIINum;
      speciesMap[103] = HNOIINum;
      speciesMap[104] = H2NOIINum;
      speciesMap[105] = H3IINum;
      speciesMap[106] = H3COIINum;
      speciesMap[107] = H3OIINum;
      speciesMap[108] = HCNHIINum;
      speciesMap[109] = HCO2IINum;
      speciesMap[110] = HeHIINum;
      speciesMap[111] = N2HIINum;
      speciesMap[112] = O2HIINum;
      speciesMap[113] = SIH5IINum;
      speciesMap[114] = SIOHIINum;
    }
#endif
  }
    ...
    for (j = 0; j < GridDimension[1]; j++)
    {
      for (i = 0; i < GridDimension[0]; i++, n++)
      {
        ...
        if (MultiSpecies)
        {
          ...
          BaryonField[HINum][n] =
              CoolData.HydrogenFractionByMass * BaryonField[iden][n] - BaryonField[HIINum][n];
  ...
  if (SetTurbulence)
  {
    ...
    if (level > 0)
      VelocityNormalization = CloudMachNumber;
    ...
    for (k = 0; k < GridDimension[2]; k++)
    {
      ...
      for (j = GridStartIndex[1]; j <= GridEndIndex[1]; j++) {
        for (i = GridStartIndex[0]; i <= GridEndIndex[0]; i++, n++) {*/
          ...
          if (CloudType >= 211 && CloudType <= 219)
          { // large colliding identical clouds
          ...
          if (CloudType >= 221 && CloudType <= 229)
          { // large colliding identical clouds, vel in cloud only
            if (r1 < CloudRadius || r2 < CloudRadius)
            {
              TurbulenceVelocity[0][n] *= VelocityNormalization;
              TurbulenceVelocity[1][n] *= VelocityNormalization;
  ...
  if (PutSink == 1 && level == 0)
  { // set it up on level zero and make it mustrefine
