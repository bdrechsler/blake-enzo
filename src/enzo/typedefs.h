...
/* FLD radiation module stuff (D. Reynolds) */ 
  ...
  O2HIDensity = 124,
  OCNIDensity = 125,
  CH3OH_DUSTIDensity = 126,
  HNCO_DUSTIDensity = 127,
  H2CO_DUSTIDensity = 128,
  CH4_DUSTIDensity = 129,
  CO_DUSTIDensity = 130,
  H2O_DUSTIDensity = 131,
  NO_DUSTIDensity = 132,
  CO2_DUSTIDensity = 133,
  N2_DUSTIDensity = 134,
  HCN_DUSTIDensity = 135,
  NH3_DUSTIDensity = 136,
  O2_DUSTIDensity = 137,
  NO2_DUSTIDensity = 138,
  HNO_DUSTIDensity = 139,
  O2H_DUSTIDensity = 140,
  H2CN_DUSTIDensity = 141,
  MG_DUSTIDensity = 142,
  HNC_DUSTIDensity = 143,
  E_DUSTIDensity = 144,
  HOCIIDensity = 145,
  CH2IIDensity = 146,
  CHIIDensity = 147,
